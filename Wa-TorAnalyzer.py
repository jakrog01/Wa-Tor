...
if __name__ == '__main__':
    ...
    strategy = PlotOscilationInTimeStrategy(True, threads_count, count_to_average, iteration_per_step)
    ...
    strategy.start_analysis(area_sizes_tuple, init_prey_populations_tuple, init_predators_populations_tuple,
